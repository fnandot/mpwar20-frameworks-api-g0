...
class AppLogGenerateCommand extends Command implements ServiceSubscriberInterface
{
            ...
            ->randomElement(
                [
                    [
                        ...
                        'context' => [
                            'user_id'   => $this->randomUserId($generator),
                    ...
                    [
                        ...
                        'context' => [
                            'route'            => $generator->randomElement(
                                ['hello', 'get_user', 'post_user', 'delete_user', 'patch_user']
                            ),
                            'route_parameters' => [],
                            'request_uri'      => $generator->url,
                            'method'           => $generator->randomElement(['GET', 'POST', 'PUT', 'PATCH', 'DELETE']),
                        ],
                    ],
                ]
            );
    ...
    private function randomUserId(Generator $generator): string
    {

        ...
        $logs = [
            [
                ...
                'context' => [
                    ...
                    'exception' => new \LaSalle\GroupZero\Command\Exception\Fake\CouldNotCreateUserException(),
                ],
            ],
            [
                'level' => LogLevel::INFO,
                ...
                'context' => [
                    'user_id' => $this->randomUserId(),
                    'exception' => new \LaSalle\GroupZero\Command\Exception\Fake\UserNotFoundException(),
                ],
            ],
            [
                'level' => LogLevel::INFO,
